...
import {header, page} from "../images_text";
import {nav, link, icon, roles} from "../images_nav";
import route from "../images_route";
import loader from "../images_loader.svelte";



import {pageConfig} from "../images_config";
import schema from "../images_form_schema";
import list from "../images_list";
