<script>/**
     * NewsSearch page is a collection of Fine Cooking newsSearch.
     *
     * @name newsSearch
     * @module
    ...
    //* page set-up boilerplate *************************************
        ...
        import {header, page} from './newsSearch_text';
        import {pageConfig} from './newsSearch_config';
    ...
    import listArray from './newsSearch_list';
