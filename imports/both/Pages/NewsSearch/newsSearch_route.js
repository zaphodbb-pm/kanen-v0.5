/**
 * Route config information for NewsSearch page.
 *
 * @name newsSearch_page_route
 * @constant {Object}
...
import {nav, link, icon, roles} from './newsSearch_nav';
import Page from './newsSearch_loader.svelte';
