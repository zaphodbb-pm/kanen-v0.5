/**
 * Text for CookingNow page.
 *
 * @name cookingNow_text
 * @constant {Object}
...
export const header = {
    en: {
        title:  "CookingNow",
        subtitle:   "Fine Cooking Cooking Now items to edit",
        body:   "",
    }
};
...
export const page = {
    ...
    form: {
        en: {
            ...
            cookingNowId: {
                label: "CookingNow Id",
                helpText: 'Format as: issue_nnn-TK_ss, where "nnn" is the issue number and "ss" is the sequence number in the ' +
                    'magazine issue',
            },
