/**
 * Configuration for CookingNow page Components.
 *
 * @name cookingNow_config
 * @constant {Object}
...
export const pageConfig =  {
    ...
    form: {
        coll:       "cookingNow",          // target collection to send submit to
        css:        "is-span-2",
    ...
    list: {
        coll:       "cookingNow",          // collection name to list
        css:        "is-span-1",
        showHdr:    true,               // show card header and title if true
