...
import {header, page} from "../articles_text";
import {nav, link, icon, roles} from "../articles_nav";
import route from "../articles_route";
import loader from "../articles_loader.svelte";



import {pageConfig} from "../articles_config";
import schema from "../articles_form_schema";
import list from "../articles_list";
