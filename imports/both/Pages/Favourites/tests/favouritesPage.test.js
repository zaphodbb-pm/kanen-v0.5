/* file constants */
const pageName = "favourites-edit";
...
import {header, page} from "../favourites_text";
import {nav, link, icon, roles} from "../favourites_nav";
import route from "../favourites_route";
import loader from "../favourites_loader.svelte";



import {pageConfig} from "../favourites_config";
