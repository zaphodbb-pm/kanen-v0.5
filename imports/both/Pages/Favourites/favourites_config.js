/**
 * Configuration for Favourites page Components.
 *
 * @name favourites_config
 * @constant {Object}
...
export const pageConfig =  {
    ...
    form: {
        coll:       "favourites",          // target collection to send submit to
        css:        "is-span-2",
    ...
    list: {
        coll:       "favourites",          // collection name to list
        css:        "is-span-1",
        showHdr:    true,               // show card header and title if true
