/**
 * Configuration for TestKitchen page Components.
 *
 * @name testKitchen_config
 * @constant {Object}
...
export const pageConfig =  {
    ...
    form: {
        coll:       "testKitchen",          // target collection to send submit to
        css:        "is-span-2",
    ...
    list: {
        coll:       "testKitchen",          // collection name to list
        css:        "is-span-1",
        showHdr:    true,               // show card header and title if true
