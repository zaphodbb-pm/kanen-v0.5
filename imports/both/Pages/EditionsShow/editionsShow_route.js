/**
 * Route config information for EditionsShow page.
 *
 * @name editionsShow_route
 * @constant {Object}
...
import {nav, link, icon, roles} from './editionsShow_nav';
import Page from './editionsShow_loader.svelte';
