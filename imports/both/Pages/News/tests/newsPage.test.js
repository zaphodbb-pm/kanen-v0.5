...
import {header, page} from "../news_text";
import {nav, link, icon, roles} from "../news_nav";
import route from "../news_route";
import loader from "../news_loader.svelte";



import {pageConfig} from "../news_config";
import schema from "../news_form_schema";
import list from "../news_list";
