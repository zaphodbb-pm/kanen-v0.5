...
import {nav, link, icon, roles} from "../footerExtras_nav";
import route from "../footerExtras_route";
import loader from "../footerExtras_loader.svelte";
