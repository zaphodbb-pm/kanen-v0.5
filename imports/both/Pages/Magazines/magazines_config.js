/**
 * Configuration for Magazines page Components.
 *
 * @name magazines_config
 * @constant {Object}
...
export const pageConfig =  {
    ...
    form: {
        coll:       "magazines",          // target collection to send submit to
        css:        "is-span-2",
    ...
    list: {
        coll:       "magazines",          // collection name to list
        css:        "is-span-1",
        showHdr:    true,               // show card header and title if true
