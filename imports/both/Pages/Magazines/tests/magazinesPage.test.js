...
import {header, page} from "../magazines_text";
import {nav, link, icon, roles} from "../magazines_nav";
import route from "../magazines_route";
import loader from "../magazines_loader.svelte";



import {pageConfig} from "../magazines_config";
