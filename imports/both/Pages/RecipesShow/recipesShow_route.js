/**
 * Route config information for RecipesShow page.
 *
 * @name recipesShow_route
 * @constant {Object}
...
import {nav, link, icon, roles} from './recipesShow_nav';
import Page from './recipesShow_loader.svelte';
