...
import {header, page} from "../notes_text";
import {nav, link, icon, roles} from "../notes_nav";
import route from "../notes_route";
import loader from "../notes_loader.svelte";



import {pageConfig} from "../notes_config";
import schema from "../notes_form_schema";
import list from "../notes_list";
