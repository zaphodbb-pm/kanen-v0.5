/**
 * Configuration for thumbnails page Components.
 *
 * @name thumbnails_config
 * @constant {Object}
...
export const pageConfig =  {
    ...
    form: {
        coll:       "thumbnails",          // target collection to send submit to
        css:        "",
    ...
    list: {
        coll:       "thumbnails",          // collection name to list
        css:        "",
        showHdr:    true,               // show card header and title if true
