/**
 * Route config information for TestKitchenShow page.
 *
 * @name testKitchenShow_route
 * @constant {Object}
...
import {nav, link, icon, roles} from './testKitchenShow_nav';
import Page from './testKitchenShow_loader.svelte';
