/**
 * Route config information for ArticlesShow page.
 *
 * @name articlesShow_route
 * @constant {Object}
...
import {nav, link, icon, roles} from './articlesShow_nav';
import Page from './articlesShow_loader.svelte';
